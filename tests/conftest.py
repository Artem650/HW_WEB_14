...
# Додаємо шлях до кореневої директорії вашого проекту до PYTHONPATH
sys.path.append("/Users/artemzhuravlev/Desktop/Домашні завдання GoIT/HW_WEB_14/")

# Імпортуємо app з main
...
test_user = {"username": "artem", "email": "artem@gmail.com", "password": "15061992"}
